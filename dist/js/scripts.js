...
var options = function(type, height, numbers , color){
  ...
  if (analytics_1 != null && typeof(analytics_1) != 'undefined') {
      var chart = new ApexCharts(analytics_1[0], options("area" , '51px' , numArr(10,99) , '#c084fc')); 
      var chart_1 = new ApexCharts(analytics_1[1], options("area" , '51px' , numArr(10,99) , '#c084fc')); 
      chart.render();       
      chart_1.render();       
  }
...
var sealsOverviewChart = new ApexCharts(sealsOverview, options('bar' , '100%', numArr(20,999) , '#c084fc')); 
